...
it.
এই সেকশনটায় ব্যাখ্যা করব আপনার ফিজিকাল কিবোর্ডের অ্যাকশন এবং OS interrupts নিয়ে।
যখন আপনি "g" কি চাপেন আপনার ব্রাউজার একটা ইভেন্ট রিসিভ করে এবং অটো-কমপ্লিট ফাংশন কাজ শুরু করে। আপনি URL bar এর নিচে বিভিন্ন সাজেশন পেতে শুরু করবেন। তবে এটা নির্ভর করে আপনার ব্রাউজারের অ্যালগরিদম এবং আপনি প্রাইভেট/ইনকগনিটো মোডে আছেন, নাকি নেই তার উপর। তবে এর বেশিরভাগ অ্যালগরিদমই সাজেশন গুলো সর্ট এবং প্রায়োরিটি ঠিক করে আপনার সার্চ হিস্ট্রি, বুকমার্ক, কুকি এবং ইন্টার্নেটের পপুলার সার্চ থেকে। আপনি যখন "google.com" লিখতে থাকেন, আপনার প্রতিটা কি-প্রেসে অসংখ্য কোড রান হয় এবং সাজেশনগুলো আরও রিফাইন হতে থাকে। আপনি পুরোটা লিখা শেষ করার আগেই ব্রাউজার "google.com" সাজেস্ট করে ফেলতে পারে। 
